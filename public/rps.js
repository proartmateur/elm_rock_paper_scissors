...
var $author$project$Components$ViewComponents$viewOptionControls = function (model) {
	return (model.p1_opt === '') ? A2(
		...
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('rock-paper-scissors__options')
			]),
		_List_fromArray(
			[
...
var $author$project$Components$ViewComponents$viewPlayerSelection = function (model) {
	return ((model.p1_opt === '') || (model.p1_opt === '')) ? $elm$html$Html$text('') : A2(
		...
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('adversary-option')
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$text(model.p1_opt)
					])),
				A2(
				$elm$html$Html$div,
				_List_Nil,
				...
				_List_fromArray(
					[
						$elm$html$Html$text(model.p2_opt)
					]))
			]));
};
	...
	return ((model.p1_opt === '') || (model.p1_opt === '')) ? $elm$html$Html$text('') : A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						_Utils_Tuple2('game-result', true),
						_Utils_Tuple2('animate__animated', true),
						_Utils_Tuple2('animate__bounce', result === 'You Win!'),
						_Utils_Tuple2('animate__headShake', result === 'You Loose!'),
						_Utils_Tuple2('animate__heartBeat', result === 'Nobody')
					]))
			]),
		_List_fromArray(
			[
...
var $author$project$RockPaperScissors$view = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('rock-paper-scissors')
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('rock-paper-scissors__display')
					]),
				_List_fromArray(
					[
